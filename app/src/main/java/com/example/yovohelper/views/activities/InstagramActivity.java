...
import com.example.yovohelper.databinding.ActivityInstagramBinding;
...
//                            binding.videoDescription.setText(description);
                        ...
                        runOnUiThread(() -> {
                            Toast.makeText(InstagramActivity.this, "Error processing video details", Toast.LENGTH_SHORT).show();
                            skeleton.showOriginal();
                        });
                    }
                }).start();
        ...
        binding.download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Thread(() -> {
                    ...
                    runOnUiThread(() -> {
                        Toast.makeText(InstagramActivity.this, "Downloading video..." , Toast.LENGTH_SHORT).show();
                    });
                }).start();
            }
        });
